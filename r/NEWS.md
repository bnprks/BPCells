...
- Fixed discrepancy between default ArchR and BPCells peak calling insertion method, where BPCells was only using the start of each fragment (pull request #143)
