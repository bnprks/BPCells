...
iterate_matrix_bernoulli_sample_uint32_t_cpp <- function(mat, prob, seed) {
    .Call(`_BPCells_iterate_matrix_bernoulli_sample_uint32_t_cpp`, mat, prob, seed)
}

iterate_matrix_bernoulli_sample_float_cpp <- function(mat, prob, seed) {
    .Call(`_BPCells_iterate_matrix_bernoulli_sample_float_cpp`, mat, prob, seed)
}

iterate_matrix_bernoulli_sample_double_cpp <- function(mat, prob, seed) {
    .Call(`_BPCells_iterate_matrix_bernoulli_sample_double_cpp`, mat, prob, seed)
}
