...
void write_tiled_insertion_bedgraph_cpp(SEXP fragments, std::vector<uint32_t> cell_groups, std::vector<std::string> output_paths, std::string mode_string, uint32_t tile_width, std::string normalization_method_string, std::vector<uint32_t> chrom_sizes);
RcppExport SEXP _BPCells_write_tiled_insertion_bedgraph_cpp(SEXP fragmentsSEXP, SEXP cell_groupsSEXP, SEXP output_pathsSEXP, SEXP mode_stringSEXP, SEXP tile_widthSEXP, SEXP normalization_method_stringSEXP, SEXP chrom_sizesSEXP) {
BEGIN_RCPP
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< SEXP >::type fragments(fragmentsSEXP);
    Rcpp::traits::input_parameter< std::vector<uint32_t> >::type cell_groups(cell_groupsSEXP);
    ...
    write_tiled_insertion_bedgraph_cpp(fragments, cell_groups, output_paths, mode_string, tile_width, normalization_method_string, chrom_sizes);
    return R_NilValue;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_BPCells_write_tiled_insertion_bedgraph_cpp", (DL_FUNC) &_BPCells_write_tiled_insertion_bedgraph_cpp, 7},
