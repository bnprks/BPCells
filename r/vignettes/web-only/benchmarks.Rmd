...
Full benchmarking/plotting code and data TSVs are available at 
[https://github.com/GreenleafLab/BPCells_paper](https://github.com/GreenleafLab/BPCells_paper).
...
In the benchmark below, we show the time and memory to perform a standardized workflow
...
We noticed that execution speed tends to scale with the number of non-zero entries in a matrix, whereas memory usage
...
<img src="benchmark-plots/peak_comparison" class="mx-auto d-block" style="max-height: 20rem" />
...
in <3 minutes. PCA is the most expensive operation BPCells performs, requiring 167 passes over the input matrix to calculate 32 PCs. Still, it completes
