...
matrices compared to an uncompressed binary format like AnnData. A single thread
can load the matrix data faster than reading uncompressed data in many cases,
due to the smaller data size and extremely fast decompression[^1].
