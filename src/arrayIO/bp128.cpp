...
BP128UIntReader::BP128UIntReader(UIntReader &&data, UIntReader &&idx, uint32_t count) :
    BP128UIntReaderBase(count),  data(std::move(data)), idx(std::move(idx)),
...
BP128UIntWriter::BP128UIntWriter(UIntWriter &&_data, UIntWriter &&_idx) :
    BP128UIntWriterBase(), data(std::move(_data)), idx(std::move(_idx)) {
    idx.write_one(0);
}
...
BP128_D1_UIntReader::BP128_D1_UIntReader(UIntReader &&data, UIntReader &&idx, UIntReader &&starts, uint32_t count) :
    BP128UIntReaderBase(count), data(std::move(data)), idx(std::move(idx)), starts(std::move(starts)),
    prev_idx(this->idx.read_one()) {}
...
BP128_D1_UIntWriter::BP128_D1_UIntWriter(UIntWriter &&_data, UIntWriter &&_idx, UIntWriter &&_starts) :
    BP128UIntWriterBase(), data(std::move(_data)), idx(std::move(_idx)), starts(std::move(_starts)) {
    idx.write_one(0);
}
...
BP128_D1Z_UIntReader::BP128_D1Z_UIntReader(UIntReader &&data, UIntReader &&idx, UIntReader &&starts, uint32_t count) :
    BP128UIntReaderBase(count), data(std::move(data)), idx(std::move(idx)), starts(std::move(starts)),
    prev_idx(this->idx.read_one()) {}
...
BP128_D1Z_UIntWriter::BP128_D1Z_UIntWriter(UIntWriter &&_data, UIntWriter &&_idx, UIntWriter &&_starts) :
    BP128UIntWriterBase(), data(std::move(_data)), idx(std::move(_idx)), starts(std::move(_starts)) {
    idx.write_one(0);
}
