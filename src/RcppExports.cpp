...
// matrix_value_checksum_double_cpp
StringVector matrix_value_checksum_double_cpp(SEXP matrix);
RcppExport SEXP _BPCells_matrix_value_checksum_double_cpp(SEXP matrixSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< SEXP >::type matrix(matrixSEXP);
    rcpp_result_gen = Rcpp::wrap(matrix_value_checksum_double_cpp(matrix));
    return rcpp_result_gen;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_BPCells_matrix_value_checksum_double_cpp", (DL_FUNC) &_BPCells_matrix_value_checksum_double_cpp, 1},
