...
Eigen::MatrixXd denseMultiplyRight(
    MatrixIterator<double> &A, const Eigen::Map<Eigen::MatrixXd> B, bool transpose_A
) {
...
Eigen::VectorXd
vecMultiplyRight(MatrixIterator<double> &A, const Eigen::Map<Eigen::VectorXd> v, bool transpose_A) {
...
Eigen::VectorXd
vecMultiplyLeft(MatrixIterator<double> &A, const Eigen::Map<Eigen::VectorXd> v, bool transpose_A) {
