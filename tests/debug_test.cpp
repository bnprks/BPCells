...
int main() {
  BPCells::BedFragments bed(
      "/Users/ben/Downloads/PackedInsertionsData/01_raw_data/atac_pbmc_10k_2.0/"
      "fragments_chr1_chr10.tsv.gz",
      "#");
  ...
  BPCells::TileMatrix mat(selected_cells, chr, start, end, tile_width,
                          chr_names);
